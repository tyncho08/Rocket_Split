-- Safe property replacement script that preserves database integrity
-- Generated automatically from scraped_properties.json
...
-- Remove favorite relationships (will need to be re-established by users)
